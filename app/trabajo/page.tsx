...
// El panel real (tarjetas de puntos asignados) se construye en la Fase 4.
export default async function TrabajoPage() {
    ...
    return (
        <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '16px' }}>
            <h1 style={{ fontSize: '22px', fontWeight: 700 }}>Panel Trabajador (placeholder)</h1>
            ...
            <p style={{ color: 'var(--fg3)', fontSize: '13px' }}>
                El panel real llega en la Fase 4.
            </p>
            <form action={async () => {
                'use server'
